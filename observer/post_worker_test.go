...
// a payload of about the given JSON size, shaped like the ones the browser polls
...
func TestWriteJSONThreshold(t *testing.T) {
	// a string of n bytes lands in a JSON body of n plus the quoting and the field name
