...
// mirrors gen.NodeShortInfo field for field: nothing is summed or dropped
...
// the runtime reports "no limit" as MaxInt64, which omitempty cannot see, so every node would
// otherwise carry a 19-digit number in the largest answer there is
