...
// this table drives both resources/templates/list and the render plans, so a lens cannot be
// announced with a mime type it does not answer with
...
// the node is always a reserved expansion: it holds an @ and dots, and a client that
// percent-encoded them would produce a uri this surface does not accept
