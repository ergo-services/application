...
// the argument differs from the field for two of the seven: the builder is shared with the
// browser
...
// a knob whose field is not set is refused: the action would read the missing argument as
// false or zero, change the setting the other way and still answer done
