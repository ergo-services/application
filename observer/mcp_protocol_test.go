...
// a tool result and a reading have different shapes
...
// every tool in the table builds its action
...
// the HTTP status and the JSON-RPC code agree
...
// an unknown tool is a bad parameter, not a missing method
...
// every tool states all of its annotations
